...
**Step 1: Search (IMPORTANT — do multiple rounds)**

Do NOT rely on a single search. Run 3-5 separate searches to get comprehensive, high-quality results.

**Search strategy for AI & Tech topics:**

Round 1 — Global AI news (English):
- Search: "AI news today" or "AI latest developments March 2026"
- Focus: OpenAI, Anthropic, Google, Meta, Microsoft, NVIDIA announcements

Round 2 — People & opinions (English):
- Search: "AI CEO founder statement this week" or "Sam Altman Dario Amodei latest"
- Focus: What builders and leaders are saying, controversies, predictions

Round 3 — Products & tools:
- Search: "AI product launch new tool 2026" or "AI agent coding tool update"
- Focus: New releases, major updates, user reactions

Round 4 — China AI (Chinese):
- Search: "AI热点 今天" or "人工智能 最新动态"
- Focus: 字节/豆包, 百度/文心, 阿里/通义, DeepSeek, 月之暗面, 智谱
- Also search: "小红书 AI" "即刻 AI" for social buzz

Round 5 — Business & funding:
- Search: "AI startup funding valuation 2026" or "AI公司 融资 估值"
- Focus: Funding rounds, revenue milestones, employee-to-valuation ratios

**For other topic areas**, adapt the same multi-round pattern:
- Business → search management trends, CEO moves, organizational changes
- Startups → search funding rounds, launches, YC/a16z portfolio news
- Finance → search market moves, earnings, policy changes
- Any topic → search "[topic] news today", "[topic] trending", "[topic] 热点"

**Quality filter — after collecting results, keep only topics that have:**
- A specific person, company, or data point (not vague trends)
- Potential for the user's unique angle (based on their profile)
- Reader relevance (the user's audience would care)

Drop generic news. Aim for 8 topics that are specific and debatable.
